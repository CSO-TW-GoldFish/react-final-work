...
function TodoList() {
    ...
    async function removeTodo(item) {
        await axios.delete(`${VITE_APP_API_URL}/todos/${item.id}`, {headers: {Authorization: token}})
        .then((response) => {
    ...
    async function getTodo(cookieToken) {
        await axios.get(`${VITE_APP_API_URL}/todos/`, {headers: {Authorization: cookieToken}})
        .then((response) => {
    ...
    async function addTodo() {
        await axios.post(`${VITE_APP_API_URL}/todos/`, {content: todo}, {headers: {Authorization: token}})
            .then((response) => {
                getTodo(token)
                setTodo('')
            })
    ...
    async function updateStatus(e, item) {
        ...
        await axios.patch(`${VITE_APP_API_URL}/todos/${item.id}/toggle`, {}, {headers: {Authorization: token}})
            .then((response) => {
    ...
    return (
        ...
        <nav>
            <h1><a href="/react-final-work/#/todoList" style={{backgroundImage: 'url("/react-final-work/logo.svg")'}}>ONLINE TODO LIST</a></h1>
            <ul>
                <li className="todo_sm"><a href="/react-final-work/#/todoList"><span>{nickname}的待辦</span></a></li>
