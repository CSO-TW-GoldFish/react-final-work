...
function SignUp() {
    ...
    function signUp() {
        ...
        (async () => {
            await axios.post(`${VITE_APP_API_URL}/users/sign_up`, form)
                .then((response) => {
                    Swal.fire({
                        title: '註冊成功',
            ...
            <div className="container signUpPage vhContainer">
                ...
                <div>
                    <form className="formControls" action="index.html">
                        ...
                        <label className="formControls_label" htmlFor="againPassword">再次輸入密碼</label>
                        <input className="formControls_input" type="password" name="password" id="againPassword" placeholder="請再次輸入密碼" onChange={(e) => setAgainPassword(e.target.value)} required />
